...
public class BooksService {
	...
	public BookDetailsInfo getBookInfo(int bookId) {
		...
		// JSPに渡すデータを設定する
		String sql = "SELECT books.id, books.title, books.author, books.publisher, books.publish_date, books.thumbnail_url, books.thumbnail_name, books.reg_date, books.upd_date, books.isbn, books.explanatory_text, rentals.id , rentals.book_id FROM books LEFT OUTER JOIN rentals "
				+ "ON rentals.book_id = books.id WHERE books.id =" + bookId;
